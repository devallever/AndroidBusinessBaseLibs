package org.xm.app.virtual.call.ui.adapter
...
class RingtoneAdapter(context: Context, resId: Int, data: MutableList<RingtoneItem>) :
    BaseRecyclerViewAdapter<RingtoneItem>(context, resId, data) {
