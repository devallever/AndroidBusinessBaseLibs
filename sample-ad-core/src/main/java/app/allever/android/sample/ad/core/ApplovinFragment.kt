...
class ApplovinFragment : BaseAdProviderFragment<FragmentTabBinding, BaseViewModel>() {

    override val providerName: String = AppLovinAdProvider.PROVIDER_NAME

    override val providerConfig = ProviderConfigConstants.APPLOVIN

    override fun getProviderClass(): Class<out IAdProvider> = AppLovinAdProvider::class.java
}
