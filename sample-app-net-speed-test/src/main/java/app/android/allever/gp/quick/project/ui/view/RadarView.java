package app.android.allever.gp.quick.project.ui.view;
 ...
 * Date:2018/5/14
 * <p>
 * https://github.com/donkingliang/RadarView
 */
public class RadarView extends View {

    //默认的主题颜色
    private int DEFAULT_COLOR = Color.parseColor("#4586F3");
    ...
    private void drawCross(Canvas canvas, int cx, int cy, int radius) {
        //水平线
        canvas.drawLine(cx - radius + DisplayHelper.INSTANCE.dip2px(0), cy, cx + radius - DisplayHelper.INSTANCE.dip2px(0), cy, mCirclePaint);

        //垂直线
        canvas.drawLine(cx, cy - radius  + DisplayHelper.INSTANCE.dip2px(0), cx, cy + radius - DisplayHelper.INSTANCE.dip2px(0), mCirclePaint);
    }
