...
public class InternetUtil {
    ...
    public static boolean isWifi(Context context) {
        return getNetworkState(context) == NETWORN_WIFI;
    }
    ...
    public static String getNetworkStateName(Context context) {
        switch (getNetworkState(context)) {
            case NETWORN_NONE: return "未知";
            case NETWORN_WIFI: return "WIFI";
            case NETWORN_2G: return "2G";
            case NETWORN_3G: return "3G";
            case NETWORN_4G: return "4G";
            case NETWORN_5G: return "5G";
        }
        return "未知";
    }
