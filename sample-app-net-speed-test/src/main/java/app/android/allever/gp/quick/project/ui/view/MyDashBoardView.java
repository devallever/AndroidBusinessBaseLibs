...
public class MyDashBoardView extends View {
     ...
     * 长刻度的长度
     */
    private float longLength = dp2px(18);

    /**
     * 短刻度长度
     */
    private float shortLength = longLength/4*3;
    ...
    public MyDashBoardView(Context context, @Nullable AttributeSet attrs) {
        ...
        int color = a.getColor(R.styleable.MyDashBoardView_dashColor, context.getResources().getColor(R.color.googleBleu));
        initPaint(color);
    }
