...
class CompanyLiangDaoFragment: ListFragment<FragmentListBinding, ListViewModel, TextDetailClickItem>() {
    ...
    override fun getList(): MutableList<TextDetailClickItem> = mutableListOf(
        TextDetailClickItem("WestVPN", "sample-company-liangdao-west"),
        TextDetailClickItem("✅FlashTunnel", "sample-app-vpn-flash-tunnel") {
