...
import app.allever.android.sample.audiovideo.databinding.FragmentAndroidTextureViewPlayerSampleBinding
import app.allever.android.sample.audiovideo.android.VideoScaleMode
import java.text.SimpleDateFormat
import java.util.Date
import java.util.Locale

class AndroidTexturePlayerSampleFragment :
    BaseFragment<FragmentAndroidTextureViewPlayerSampleBinding, BaseViewModel>() {

    private lateinit var player: AndroidTexturePlayer
    ...
    override fun inflate(): FragmentAndroidTextureViewPlayerSampleBinding =
        FragmentAndroidTextureViewPlayerSampleBinding.inflate(layoutInflater)
    ...
    private fun initPlayer() {
        player = AndroidTexturePlayer().apply {
            attach(mBinding.textureView)
