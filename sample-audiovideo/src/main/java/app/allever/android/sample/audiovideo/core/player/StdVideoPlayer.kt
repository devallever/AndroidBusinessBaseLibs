...
import app.allever.android.sample.audiovideo.databinding.StdVideoPlayerBinding
        ...
        return try {
            ...
            if (result == null || result!!.isEmpty()) {
                ...
                context.contentResolver.query(
                    ...
                    if (cursor.moveToFirst()) {
                        val nameIndex =
                            cursor.getColumnIndex(android.provider.MediaStore.Video.Media.DISPLAY_NAME)
                        if (nameIndex >= 0) {
                            result = cursor.getString(nameIndex)
                        }
                    }
