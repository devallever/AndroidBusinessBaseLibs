...
@Route(path = "/djcsj/main")
class SampleDjCsjMainActivity: ListActivity<ActivityListBinding, ListViewModel, TextClickItem>() {
    override fun getPageTitle(): String = "DJ-CSJ"

    override fun getAdapter(): BaseQuickAdapter<TextClickItem, *> = TextClickAdapter()

    override fun getList(): MutableList<TextClickItem> = mutableListOf(
        TextClickItem("短剧-穿山甲") {
            ActivityHelper.startActivity(CsjMainActivity::class.java)
        }
    )
}