...
Java_z_app_allever_android_sample_jni_Jni_intFromJni(JNIEnv *env, jobject thiz, jint int_value) {
    LOGD("%d", int_value);
...
extern "C"
JNIEXPORT jintArray JNICALL
Java_z_app_allever_android_sample_jni_Jni_intArrayFromJni(JNIEnv *env, jobject thiz,
                                                        jintArray int_array) {
...
Java_z_app_allever_android_sample_jni_Jni_floatFromJni(JNIEnv *env, jobject thiz, jfloat float_value) {
    LOGD("%f", float_value);
...
Java_z_app_allever_android_sample_jni_Jni_floatArrayFromJni(JNIEnv *env, jobject thiz,
                                                          jfloatArray float_array) {
    //jni中获取array长度需要使用JNIEnv对象方法GetArrayLength(env, array)来获取
...
Java_z_app_allever_android_sample_jni_Jni_doubleFromJni(JNIEnv *env, jobject thiz, jdouble double_value) {
    LOGD("%f", double_value);
...
Java_z_app_allever_android_sample_jni_Jni_doubleArrayFromJni(JNIEnv *env, jobject thiz,
                                                           jdoubleArray double_array) {
    //jni中获取array长度需要使用JNIEnv对象方法GetArrayLength(env, array)来获取
...
Java_z_app_allever_android_sample_jni_Jni_byteFromJni(JNIEnv *env, jobject thiz, jbyte byte_value) {
    LOGD("%d", byte_value);
...
Java_z_app_allever_android_sample_jni_Jni_byteArrayFromJni(JNIEnv *env, jobject thiz,
...
//Java_z_app_allever_android_sample_jni_Jni_stringListFromJni(JNIEnv *env, jobject thiz) {
//    jstring
//}

extern "C"
JNIEXPORT jstring JNICALL
Java_z_app_allever_android_sample_jni_Jni_stringFromJni(JNIEnv *env, jobject thiz, jstring string_value) {
    //获取jstring
...
Java_z_app_allever_android_sample_jni_Jni_stringArrayFromJni(JNIEnv *env, jobject thiz,
                                                           jobjectArray string_array) {
