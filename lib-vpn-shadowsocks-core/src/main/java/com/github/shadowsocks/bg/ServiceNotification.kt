    ...
    private val callback: IShadowsocksServiceCallback by lazy {
        object : IShadowsocksServiceCallback.Stub() {
            ...
            override fun trafficUpdated(profileId: Long, stats: TrafficStats) {
                ...
                builder.apply {
                    setContentText((service as Context).getString(ShadowsSocksConfig.notificationTraffic,
                            service.getString(ShadowsSocksConfig.notificationSpeed, Formatter.formatFileSize(service, stats.txRate)),
                            service.getString(ShadowsSocksConfig.notificationSpeed, Formatter.formatFileSize(service, stats.rxRate))))
                    setSubText(service.getString(ShadowsSocksConfig.notificationTraffic,
...
//            .setColor(ContextCompat.getColor(service, R.color.material_primary_500))
            .setTicker(ShadowsSocksConfig.tickerSuccess)
