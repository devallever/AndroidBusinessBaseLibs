...
object Core : Configuration.Provider {
    ...
    val autoStopIntent by lazy {
        PendingIntent.getActivity(
            app,
            1,
            Intent(app, ShadowsSocksConfig.notificationMainClz).apply {
                setFlags(Intent.FLAG_ACTIVITY_REORDER_TO_FRONT)
                putExtra("connectAutoStop", true)
            },
    ...
    const val AUTO_STOP_NOTI_ID = 123456
    fun cancelAutoNotification() {
        notification.cancel(AUTO_STOP_NOTI_ID)
    }
}
