...
public class SpaceItemDecoration extends RecyclerView.ItemDecoration{
     ...
     * @param spanCount     列数
     */
    public SpaceItemDecoration(Context context, int spanCount, int rowSpacingDp, int columnSpacingDp) {
        this.mSpanCount = spanCount;

        this.mRowSpacing= dip2px(context,rowSpacingDp);
//        this.mRowSpacing = rowSpacing;
//        this.mColumnSpacing = columnSpacing;
        this.mColumnSpacing= dip2px(context,columnSpacingDp);
