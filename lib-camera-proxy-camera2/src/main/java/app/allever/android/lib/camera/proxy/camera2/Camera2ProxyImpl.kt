...
import app.allever.android.lib.camera.core.proxy.AutoFitSurfaceView
...
import app.allever.android.lib.camera.core.proxy.getPreviewOutputSize
...
class Camera2ProxyImpl : ICameraProxy {
    ...
    private val TAG = "Camera-Camera2ProxyImpl"
    ...
    private val mCameraManager by lazy {
        App.context.getSystemService(Context.CAMERA_SERVICE) as CameraManager
    }
    ...
    override fun openCamera(cameraFacing: Int) {
        log(TAG, "openCamera: $cameraFacing")
...
//            val size = android.util.Size(1920, 1080);
            ...
            log(TAG, "mImageReader.hashCode = ${mImageReader.hashCode()}")
