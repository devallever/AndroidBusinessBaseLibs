...
public class DayMatterDetailActivity extends BaseActivity<IDayMatterDetailView, DayMatterDetailPresenter> implements IDayMatterDetailView {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.dm_activity_day_matter_detail);
        findView();
        ...
        initToolbar(mToolbar, R.string.dm_app_name);
    ...
    private void findView() {
        ...
        mVp = findViewById(R.id.id_day_matter_detail_vp);
        mBtnShare = findViewById(R.id.id_day_matter_detail_btn_share);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        inflater.inflate(R.menu.dm_menu_day_matter_detail,menu);
        return true;
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.id_menu_day_matter_detail_edit) {
