...
import z.app.allever.android.sample.function.databinding.FragmentUserManageBinding
import z.app.allever.android.sample.function.im.user.UserInfo
import z.app.allever.android.sample.function.im.viewmodel.UserManageViewModel
...
class UserManageFragment : BaseMvvmFragment<FragmentUserManageBinding, UserManageViewModel>() {
    ...
    private val imageLauncher = MediaPickerCore.registerPickerLauncher(this) {
        ...
        mBinding.etAvatar.setText(it[0].path)
    }
