...
import z.app.allever.android.sample.function.im.message.ImageMessage
import z.app.allever.android.sample.function.im.message.TextMessage
import z.app.allever.android.sample.function.im.message.VideoMessage
import z.app.allever.android.sample.function.im.ui.ConversationActivity.Companion.EXTRA_OTHER_USER_ID
import z.app.allever.android.sample.function.im.ui.adapter.ExpandAdapter
import z.app.allever.android.sample.function.im.ui.adapter.ExpandItem
import z.app.allever.android.sample.function.im.ui.adapter.MessageAdapter
...
//        }
    ...
    fun sendMediaMessage(media: MediaItem, mediaType: MediaType.Type) {
        when (mediaType) {
            MediaType.Type.IMAGE -> sendImageMessage(media)
            MediaType.Type.VIDEO -> sendVideoMessage(media)
            else -> ""
        }
    }

    fun sendImageMessage(media: MediaItem) {
        val message = ImageMessage()
        message.user = userMe
        message.actionType = ActionType.SEND
        message.path = media.path
        message.url = media.path
        (media as? MediaItem.Image)?.let {
    ...
    fun sendVideoMessage(media: MediaItem) {
