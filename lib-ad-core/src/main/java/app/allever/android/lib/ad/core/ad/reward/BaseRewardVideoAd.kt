package app.allever.android.lib.ad.core.ad.reward

import android.app.Activity
import android.util.Log
import app.allever.android.lib.ad.core.callback.IAdCallback

abstract class BaseRewardVideoAd : IRewardVideoAd {

    companion object {
        private const val TAG = "BaseRewardVideoAd"
    }
    ...
    override fun load(activity: Activity, adId: String, callback: IAdCallback?) {
        ...
        doLoad(activity, adId, object : IAdCallback {
            ...
            override fun onAdFail(errorCode: Int, errorMessage: String) {
                isLoaded = false
                Log.w(TAG, "Reward video ad load failed: $errorMessage")
    ...
    override fun show(activity: Activity, callback: IAdCallback?) {
        if (!isLoaded) {
            Log.w(TAG, "Reward video ad not loaded yet")
            return
        }
