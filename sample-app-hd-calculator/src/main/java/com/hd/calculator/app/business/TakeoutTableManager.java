...
public class TakeoutTableManager {

    private static final String KEY_COUNT = "takeout_daily_counter";
    private static final String KEY_LAST_RESET_DATE = "takeout_last_reset_date";
    private static final int RESET_HOUR = 7; // 早上7点重置

    public static TakeoutTableManager getIns() {
    ...
    private static class SingletonHolder {
        private static final TakeoutTableManager INSTANCE = new TakeoutTableManager();
    }
