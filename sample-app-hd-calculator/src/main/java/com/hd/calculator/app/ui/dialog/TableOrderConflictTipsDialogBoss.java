...
public class TableOrderConflictTipsDialogBoss extends BaseDialog<HdcDialogTableOrderConflictTipsBossBinding> {
    ...
    public TableOrderConflictTipsDialogBoss(@NonNull Context context, int tableCode) {
        super(context);
        mTableCode = tableCode;
    }

    @Override
    protected HdcDialogTableOrderConflictTipsBossBinding getViewBinding() {
        return HdcDialogTableOrderConflictTipsBossBinding.inflate(getLayoutInflater());
    }
    ...
    protected void initView() {
        ...
        mBinding.btnLocal.setOnClickListener(v -> {
            if (mOptionClickListener != null) {
                mOptionClickListener.onBossClickLocal();
            }
            dismiss();
        });
        mBinding.btnCloud.setOnClickListener(v -> {
            if (mOptionClickListener != null) {
                mOptionClickListener.onBossClickServer();
            }
            dismiss();
        });
    }
    ...
    public interface OptionClickListener{
        void onBossClickLocal();
        void onBossClickServer();
    }
}
