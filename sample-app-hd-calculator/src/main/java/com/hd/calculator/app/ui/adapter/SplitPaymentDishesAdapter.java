...
public class SplitPaymentDishesAdapter extends RecyclerView.Adapter<SplitPaymentDishesAdapter.ViewHolder> {
    ...
    public SplitPaymentDishesAdapter(List<DishesItem> data) {
        this.data = data;
    }
