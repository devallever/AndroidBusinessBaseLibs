...
import com.hd.calculator.app.databinding.HdcItemTableManageBinding;
...
public class TableManageAdapter extends RecyclerView.Adapter<TableManageAdapter.ViewHolder> {
    ...
    public TableManageAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new ViewHolder(HdcItemTableManageBinding.inflate(LayoutInflater.from(parent.getContext()), parent, false));
    }

    @Override
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        TableManageItem item = data.get(position);
        HdcItemTableManageBinding binding = holder.getBinding();
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        private final HdcItemTableManageBinding binding;

        public ViewHolder(HdcItemTableManageBinding binding) {
            super(binding.getRoot());
            this.binding = binding;
        }

        public HdcItemTableManageBinding getBinding() {
            return binding;
        }
