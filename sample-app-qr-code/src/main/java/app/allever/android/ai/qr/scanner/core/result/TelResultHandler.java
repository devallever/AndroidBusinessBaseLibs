...
public final class TelResultHandler extends ResultHandler {
    ...
    public void handleButtonPress(int index) {
        ...
        switch (index) {
            case 0:
                ...
                break;
            case 1:
                copy2Clipboard(telResult.getNumber());
                break;
            case 2:
                share(telResult.getDisplayResult());
                break;
        }
    }
    ...
    public int getDisplayTitle() {
        return com.google.zxing.client.android.R.string.zxing_result_tel;
    }
}
