...
object ResultUIModel {
    private val prt2UIData = mapOf(
            ParsedResultType.ADDRESSBOOK to getUIData(R.drawable.qr_icon_user, R.string.result_type_name_addressbook, "#ffa564", "#ff8f30")
            , ParsedResultType.EMAIL_ADDRESS to getUIData(R.drawable.qr_icon_email, R.string.result_type_name_email_address, "#e57ab9", "#de49a4")
            , ParsedResultType.PRODUCT to getUIData(R.drawable.qr_icon_bar, R.string.result_type_name_product, "#a1adb8", "#7b8996")
            , ParsedResultType.URI to getUIData(R.drawable.qr_icon_url, R.string.result_type_name_uri, "#5589cc", "#0075c1")
            , ParsedResultType.TEXT to getUIData(R.drawable.qr_icon_word, R.string.result_type_name_text, "#00c8e1", "#00bbdc")
            , ParsedResultType.GEO to getUIData(R.drawable.qr_icon_location, R.string.result_type_name_geo, "#ff706c", "#ff3942")
            , ParsedResultType.TEL to getUIData(R.drawable.qr_icon_number, R.string.result_type_name_tel, "#5462b5", "#4b4ab2")
            , ParsedResultType.SMS to getUIData(R.drawable.qr_icon_message, R.string.result_type_name_sms, "#a5cb00", "#7fb700")
            , ParsedResultType.CALENDAR to getUIData(R.drawable.qr_icon_bar, R.string.result_type_name_calendar, "#a1adb8", "#7b8996")
            , ParsedResultType.WIFI to getUIData(R.drawable.qr_icon_wifi, R.string.result_type_name_wifi, "#92d957", "#7cc43a")
            , ParsedResultType.ISBN to getUIData(R.drawable.qr_icon_bar, R.string.result_type_name_isbn, "#a1adb8", "#7b8996")
            , ParsedResultType.VIN to getUIData(R.drawable.qr_icon_bar, R.string.result_type_name_vin, "#a1adb8", "#7b8996")


            , ParsedResultType.INSTAGRAM to getUIData(R.drawable.qr_icon_instagram, R.string.result_type_name_instagram, "#f58243", "#eb7949", false)
            , ParsedResultType.FACEBOOK to getUIData(R.drawable.qr_icon_facebook, R.string.result_type_name_facebook, "#3d5ea6", "#3b5999", false)
            , ParsedResultType.WHATSAPP to getUIData(R.drawable.qr_icon_whatsapp, R.string.result_type_name_whatsapp, "#00e676", "#05d570", false)
            , ParsedResultType.YOUTUBE to getUIData(R.drawable.qr_icon_youtube, R.string.result_type_name_youtube, "#e93323", "#d62d1e", false)
            , ParsedResultType.TWITTER to getUIData(R.drawable.qr_icon_twitter, R.string.result_type_name_twitter, "#40b6fc", "#2ba9fc", false)
            , ParsedResultType.SPOTIFY to getUIData(R.drawable.qr_icon_spotify, R.string.result_type_name_spotify, "#1ed762", "#21d55d", false)
            , ParsedResultType.VIBER to getUIData(R.drawable.qr_icon_viber, R.string.result_type_name_viber, "#8d4cc8", "#7e4aa8", false)


    )
    public val defaultUIData = prt2UIData[ParsedResultType.TEXT]!!
    public val clipboardUIData = getUIData(R.drawable.qr_icon_clipboard, R.string.qr_share_type_clipboard, "#a1adb8", "#7b8996")
