...
final class QRCodeEncoder {
  ...
  public ParsedResult getParsedResult(Activity activity) {
    ResultHandler resultHandler = ResultHandlerFactory.makeResultHandler(activity, getResult());
  ...
  Bitmap encodeAsBitmap() throws WriterException {
    ...
    Bitmap encodeAsBitmap(CustomEncodeParamsBean paramsBean) throws WriterException {
        String contentsToEncode = contents;
        if (contentsToEncode == null) {
            return null;
        }
        ...
        //有图片
        if (paramsBean.getBitmapPath() != null) {
        ...
        return CustomQrCodeManager.drawCustomQrCodeBitmap(result,paramsBean);
    }
