...
public final class AddressBookResultHandler extends ResultHandler {
  ...
  private static final int[] BUTTON_TEXTS = {
    R.string.button_add_contact2,
    R.string.button_copy_name,
    R.string.button_copy_number,
  ...
  public AddressBookResultHandler(Activity activity, ParsedResult result) {
    ...
    fields[1] = names != null && names.length > 0 && names[0] != null && !names[0].isEmpty();
  ...
  public void handleButtonPress(int index) {
    ...
    switch (action) {
      ...
      case 1:
        ...
        ParsedResult.maybeAppend(addressResult.getNames(), names);
        copy2Clipboard(names.toString());
        break;
      case 2:
        copy2Clipboard(addressResult.getPhoneNumbers()[0]);
        break;
      case 3:
        share(addressResult.getDisplayResult());
        break;
      default:
        break;
    }
  ...
  public int getDisplayTitle() {
    return com.google.zxing.client.android.R.string.zxing_result_address_book;
  }
}
