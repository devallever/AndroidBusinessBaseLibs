...
//    return result.toString();
    ...
    // WIFI:S:abc;P:qwert;T:WPA;H:1;
    return String.format("WIFI:S:%s;P:%s;T:%s;H:%d;", ssid, password, networkEncryption, hidden?1:0);
  }

  @Override
  public String revertRawData(){
      //WIFI:T:WPA;S:ALLINAI;H:false;E:PWD;H:PAP;A:;I:;P:Allinai@2018;;
      return String.format("WIFI:T:%s;S:%s;H:%s;E:PWD;H:PAP;A:;I:;P:%s;;",networkEncryption, ssid, hidden,password);
  }
