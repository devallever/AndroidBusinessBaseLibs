 ...
 * dip to px
 */
fun dp2px(dipValue: Float, context: Context = ChargeApp.instance): Int {
 ...
 * px to dip
 */
fun px2dp(pxValue: Int, context: Context = ChargeApp.instance): Float {
    if (pxValue == 0)
        return 0f
 ...
 * sp to px
 */
fun sp2px(spValue: Float, context: Context = ChargeApp.instance): Int {
 ...
 * px to sp
 */
fun spFromPx(pxValue: Int, context: Context = ChargeApp.instance): Float {
    if (pxValue == 0)
        return 0f
...
fun getWindowWidth(context: Context = ChargeApp.instance): Int {
...
fun getStatusBarHeight(context: Context = ChargeApp.instance): Int {
    var height = 0
...
fun getNavigationBarHeight(context: Context = ChargeApp.instance): Int {
    var height = 0
