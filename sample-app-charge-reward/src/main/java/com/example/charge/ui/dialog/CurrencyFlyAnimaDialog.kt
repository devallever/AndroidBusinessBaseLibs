...
import com.example.charge.databinding.DialogCurrencyFlyAnimaBinding
import com.lxj.xpopup.impl.FullScreenPopupView
import kotlin.random.Random

class CurrencyFlyAnimaDialog(context: Context, private val viewGroup: ViewGroup, private val animCount: Int = 10, private val targetView: View, private val resId: Int, private val dismissCallBack: () -> Unit) :
    FullScreenPopupView(context) {

    private lateinit var binding: DialogCurrencyFlyAnimaBinding


    override fun getImplLayoutId(): Int {
        return R.layout.dialog_currency_fly_anima
    }

    override fun onCreate() {
        super.onCreate()
        binding = DialogCurrencyFlyAnimaBinding.bind(this.contentView)
    ...
    private fun processAnimator() {
        try {
            for (index in 0 until animCount) {
                ...
                binding.rootView.addView(startView)
                ...
                animator.addListener(object : AnimatorListenerAdapter() {
                    override fun onAnimationEnd(animation: Animator) {
                        ...
                        binding.rootView.removeView(startView)
