...
//import com.photoeditor.function.sticker.emoji.StickerConstant;
//import com.photoeditor.preference.SPDataManager;
//import com.photoeditor.function.share.ShareImageTools;
...
import com.allever.video.editor.utils.ExtSdcardUtils;
import com.allever.video.editor.utils.FileUtil;
import com.allever.video.editor.utils.PhoneInfo;
...
//    private static final String CONFIG_JSON_MD5 = "06B2D3B23DCE96E1619D2B53D6C947EC";
    ...
    //music
    private static final String MUSIC_MD5 = "18D6769919266CD0BD6CD78AA405D5D0";

    public static final String EXTERNAL_CACHE_DIR = FileUtils.getExternalCacheDir(App.getContext(), "files");
    ...
    //调试时放在外部缓存目录
    public static final String INTERNAL_FONT_DIR = EXTERNAL_CACHE_DIR + File.separator + FONT_MD5;
    public static final String INTERNAM_MUSIC_DIR = EXTERNAL_CACHE_DIR + File.separator + MUSIC_MD5;
    //public static final String INTERNAM_MUSIC_DIR = INTERNAL_RES_DIR + File.separator + MUSIC_MD5;


    public static final String ROOT_DIR = Environment.getExternalStorageDirectory().getAbsolutePath()
            + File.separator + "fantuan" + File.separator +  "videoeditor" + File.separator + "files";

    public static final String RESOURCE_DIR = ROOT_DIR + File.separator + RESOURCE_MD5;

    public static final String CONFIG_DIR = INTERNAL_ROOT_DIR + File.separator + CONFIG_DIR_MD5;
    ...
    public static final String RES_MUSIC_DIR = RESOURCE_DIR + File.separator + MUSIC_MD5;
