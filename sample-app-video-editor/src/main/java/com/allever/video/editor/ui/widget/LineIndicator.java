...
public class LineIndicator extends View {
    ...
    private int mCursorColor = App.getContext().getResources().getColor(R.color.indicator_cursor_color);
    private int mLineColor = App.getContext().getResources().getColor(R.color.indicator_line_color);
    // 半径
    private float mCursorSize = DeviceUtils.dip2px(App.getContext(), 3f);
