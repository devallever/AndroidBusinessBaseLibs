...
object TabModel {
    ...
    enum class Tab private constructor(
         ...
         *
         */
//        CAPTURE(CaptureFragment::class.java, R.drawable.tab_icon_scan, R.string.tab_name_capture),
//        HISTORY(HistoryFragment::class.java, R.drawable.tab_icon_history, R.string.tab_name_history),
//        SHARE(ShareFragment::class.java, R.drawable.tab_icon_category, R.string.tab_name_share),
...
//            }
     ...
     */
    private val mTabScrolledToTop = BooleanArray(TabModel.Tab.values().size)
    ...
    fun getTab(ordinal: Int): Tab {
        return TabModel.Tab.values()[ordinal]
    }
