...
public class ThumbnailBean implements Parcelable{
	...
	public ThumbnailBean(String path, long date, boolean isChecked, Uri uri, int degree, int type, boolean autoPlay) {
		mPath = path;
		mDate = date;
