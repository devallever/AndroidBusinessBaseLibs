...
public class State {
    ...
    public void translateBy(View view, float dx, float dy) {
//        Log.e("breeze","translateBy   dx "+dx + ", dy"+dy);
        if(view == null) {
            return;
        }
        view.setTranslationX(view.getX()+dx);
        view.setTranslationY(view.getY()+dy);
//        Log.e("breeze","translateBy   view X"+view.getX() + ", view Y"+view.getY());
        matrix.postTranslate(dx, dy);
        updateFromMatrix(false, false); // only translation is changed
    }

    public void translateTo(View view,float x, float y) {
//        Log.e("breeze","translateTo "+"this.x ："+this.x +",this.y" +this.y +"  dx "+x + ", dy"+y);
        if(view == null) {
            return;
        }
    ...
    public void zoomBy(View view,float factor, float pivotX, float pivotY) {
        Log.e("breeze","zoomBy   pivotX"+pivotX + ", pivot Y"+pivotY + " ,factor"+factor);
        if(view == null) {
            return;
        }
    ...
    public void zoomTo(View view,float zoom, float pivotX, float pivotY) {
        if(view == null) {
            return;
        }
        view.setPivotX(pivotX);
        view.setPivotY(pivotY);
        view.setScaleX(zoom / this.zoom);
        view.setScaleY(zoom / this.zoom);
        matrix.postScale(zoom / this.zoom, zoom / this.zoom, pivotX, pivotY);
        updateFromMatrix(true, false); // zoom & translation are changed
    }

    public void rotateBy(View view,float angle, float pivotX, float pivotY) {
        if(view == null) {
            return;
        }
    ...
    public void rotateTo(View view,float angle, float pivotX, float pivotY) {
        if(view == null) {
            return;
        }
        view.setPivotX(pivotX);
        view.setPivotY(pivotY);
        view.setRotation(-rotation + angle);
     ...
     */
    protected void updateFromMatrix(boolean updateZoom, boolean updateRotation) {
