...
import com.alsg.bakericon.databinding.SiRvFrameImageBigBinding
...
class BigFrameImgAdapter :
    BaseQuickAdapter<SingleItem, BaseViewHolder>(R.layout.si_rv_frame_image_big) {
    override fun convert(holder: BaseViewHolder, item: SingleItem) {
        val binding = SiRvFrameImageBigBinding.bind(holder.itemView)
