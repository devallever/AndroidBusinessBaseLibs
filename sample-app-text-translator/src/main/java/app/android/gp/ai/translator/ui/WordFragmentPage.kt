...
import app.android.gp.ai.translator.databinding.FWordBinding
...
class WordFragmentPage : AppMvpFragment<WordView, WordPresenter>(), WordView, View.OnClickListener {
    ...
    private lateinit var mBinding: FWordBinding

    override fun getContentView(): View {
        mBinding = FWordBinding.inflate(layoutInflater)
...
//                toast("onRemoveClicked")
    ...
    fun onUpdateRecordEvent(updateRecordEvent: UpdateRecordEventB) {
//        initEditMode()
        getLikeHistory()
    }
...
//        initEditMode()
    ...
    companion object {
        fun newInstance(): WordFragmentPage = WordFragmentPage()
    }
}