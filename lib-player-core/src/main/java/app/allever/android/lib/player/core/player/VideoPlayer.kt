...
import app.allever.android.lib.player.core.cache.VideoCacheManager
import app.allever.android.lib.player.core.engine.IPlayerEngine
import app.allever.android.lib.player.core.engine.IPlayerEngineListener
import app.allever.android.lib.player.core.engine.MediaPlayerEngine
import app.allever.android.lib.player.core.render.IVideoRender
...
class VideoPlayer(
    ...
    fun setAssetSource(path: String) {
        try {
            ...
            _state = PlayerState.ERROR
            _playerListener?.onError(
                PlayerErrorCode.ASSET_COPY_FAILED,
