...
import app.allever.android.lib.player.core.databinding.VideoPlayerViewBinding
...
class VideoPlayerView @JvmOverloads constructor(
    ...
    private fun updateButtonStates() {
        ...
        if (isPlaying) {
            binding.ivVPPlayPause.setImageResource(R.drawable.lpc_ic_sample_video_player_view_pause)
        } else {
            binding.ivVPPlayPause.setImageResource(R.drawable.lpc_ic_sample_video_player_view_play)
        }
    }
