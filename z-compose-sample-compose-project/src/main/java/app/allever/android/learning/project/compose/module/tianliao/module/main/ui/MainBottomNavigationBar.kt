...
fun MainBottomBar(select: Int, onItemClick: (Int) -> Unit) {
    Row(
        ...
        BottomTabItem(
            "聊群",
            if (select == 0) R.drawable.zcp_ic_chatroom_checked else R.drawable.zcp_ic_chatroom_unchecked,
            Modifier
                .weight(1f)
                .clickable {
                    onItemClick(0)
        ...
        BottomTabItem(
            "聊圈",
            if (select == 1) R.drawable.zcp_ic_moment_checked else R.drawable.zcp_ic_moment_unchecked,
            Modifier
                .weight(1f)
                .clickable {
                    onItemClick(1)
        ...
        BottomTabItem(
            "聊信",
            if (select == 2) R.drawable.zcp_ic_message_checked else R.drawable.zcp_ic_message_unchecked,
            Modifier
                .weight(1f)
                .clickable {
                    onItemClick(2)
        ...
        BottomTabItem(
            "我的",
            if (select == 3) R.drawable.zcp_ic_mine_check else R.drawable.zcp_ic_mine_uncheck,
            Modifier
                .weight(1f)
                .clickable {
                    onItemClick(3)
