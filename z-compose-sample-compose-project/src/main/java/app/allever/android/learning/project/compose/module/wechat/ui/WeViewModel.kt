...
class WeViewModel : ViewModel() {
    ...
    var chats by mutableStateOf(
        listOf(
            Chat(
                friend = User("gaolaoshi", "高老师", R.drawable.zcp_avatar_1),
                mutableStateListOf(
                    Msg(
                        from = User("gaolaoshi", "高老师", R.drawable.zcp_avatar_1),
                        text = "你好啵",
                        "14:20"
                    ),
            ...
            Chat(
                friend = User("lanyangyang", "喜洋洋", R.drawable.zcp_avatar_2),
                mutableStateListOf(
                    Msg(
                        from = User("lanyangyang", "喜洋洋", R.drawable.zcp_avatar_2),
                        text = "你好美女",
                        "18:20"
                    ),
