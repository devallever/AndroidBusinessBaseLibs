...
fun BottomBar(selected: Int, click: (position: Int) -> Unit) {
    ...
    Row(Modifier.background(Color.White)) {
        TabItem(
            if (selected == 0) R.drawable.zcp_ic_chatroom_checked else R.drawable.zcp_ic_chatroom_unchecked,
        ...
        TabItem(
            if (selected == 1) R.drawable.zcp_ic_chatroom_checked else R.drawable.zcp_ic_chatroom_unchecked,
        ...
        TabItem(
            if (selected == 2) R.drawable.zcp_ic_chatroom_checked else R.drawable.zcp_ic_chatroom_unchecked,
        ...
        TabItem(
            if (selected == 3) R.drawable.zcp_ic_chatroom_checked else R.drawable.zcp_ic_chatroom_unchecked,
